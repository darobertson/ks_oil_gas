#       Download and combine annual data for KS oil and gas production
...
dest=file.path(processeddatafolder, "KS_oil_and_gas_annual_production_data.Rdata")
save(list=c("KS_oil.df", "KS_counties"),file=dest)
